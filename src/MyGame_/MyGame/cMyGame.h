...
#ifndef GE3D_CMYGAME_H
#define GE3D_CMYGAME_H
...
namespace GE3D
{
	...
	private:
		...
		GE3D::Graphics::cMesh* m_sphereMesh = nullptr;
		...
		GE3D::GameFramework::cGameObject* m_sphereGameObject = nullptr;
		...
		const char* GetMainWindowClassName() const final { return "Sample GE3D MyGame Main Window Class"; }
