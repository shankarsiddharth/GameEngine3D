...
size_t GE3D::cMyGame::s_numberOfPairsToRender = 0;

const char* GE3D::cMyGame::GetPlatformName() const
{
	return
...
void GE3D::cMyGame::SubmitDataToBeRendered(const float i_elapsedSecondCount_systemTime,
...
void GE3D::cMyGame::UpdateSimulationBasedOnInput()
{
	// Is the user pressing the Q key?
	if (UserInput::IsKeyPressed('R'))
	{
		//GE3D::Logging::OutputMessage("Q Input Key Pressed");
	...
	{
		m_sphereGameObject->Move(GE3D::Math::sVector(0.0f, velocity, 0.0f));
	}
	else if (UserInput::IsKeyPressed('A'))
	{
		m_sphereGameObject->Move(GE3D::Math::sVector(-velocity, 0.0f, 0.0f));
	}
...
void GE3D::cMyGame::UpdateSimulationBasedOnTime(const float i_elapsedSecondCount_sinceLastUpdate)
{

}


void GE3D::cMyGame::UpdateBasedOnTime(const float i_elapsedSecondCount_sinceLastUpdate)
{
	//Update Camera
...
void GE3D::cMyGame::UpdateBasedOnInput()
{
...
GE3D::cResult GE3D::cMyGame::Initialize()
{
	auto result = GE3D::Results::Success;

	RegisterOnImGuiRenderUI(std::bind(&cMyGame::RenderUI, this));
...
GE3D::cResult GE3D::cMyGame::CleanUp()
{
...
GE3D::cResult GE3D::cMyGame::InitializeGeometry()
{
	auto result = GE3D::Results::Success;
	...
	result = GE3D::Graphics::cMesh::CreateMesh("data/Meshes/sonic.bmasset", m_sphereMesh);
...
GE3D::cResult GE3D::cMyGame::InitializeShadingData()
{
	auto result = GE3D::Results::Success;
...
GE3D::cResult GE3D::cMyGame::InitializePairs()
{
	auto result = GE3D::Results::Success;
...
GE3D::cResult GE3D::cMyGame::InitializeGameObjects()
{
	auto result = GE3D::Results::Success;
	...
	m_sphereGameObject = new GE3D::GameFramework::cGameObject(game_object_position, game_object_rotation);
...
GE3D::cResult GE3D::cMyGame::InitializeStory()
{
	auto result = GE3D::Results::Success;
...
void GE3D::cMyGame::GetDefaultInitialResolution(uint16_t& o_width, uint16_t& o_height) const
{
	o_width = 900;
	o_height = 900;
}

void GE3D::cMyGame::RenderUI()
{
