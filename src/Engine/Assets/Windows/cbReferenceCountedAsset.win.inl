#ifndef GE3D_ASSETS_CBREFERENCECOUNTEDASSET_WIN_INL
#define GE3D_ASSETS_CBREFERENCECOUNTEDASSET_WIN_INL
...
template <class tAsset>
	inline void GE3D::Assets::cbReferenceCountedAsset<tAsset>::IncrementReferenceCount()
{
	GE3D_ASSERT( m_referenceCount > 0 );
	GE3D_ASSERT( ( reinterpret_cast<uintptr_t>( &m_referenceCount ) % 4 ) == 0 );	// The reference count must be 32-bit aligned
...
template <class tAsset>
	inline void GE3D::Assets::cbReferenceCountedAsset<tAsset>::DecrementReferenceCount()
{
	GE3D_ASSERT( m_referenceCount > 0 );
	GE3D_ASSERT( ( reinterpret_cast<uintptr_t>( &m_referenceCount ) % 4 ) == 0 );	// The reference count must be 32-bit aligned
...
#endif	// GE3D_ASSETS_CBREFERENCECOUNTEDASSET_WIN_INL
