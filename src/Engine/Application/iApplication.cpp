...
double GE3D::Application::iApplication::GetElapsedSecondCount_systemTime() const
{
	return Time::ConvertTicksToSeconds( m_tickCount_systemTime_current - m_tickCount_systemTime_whenApplicationStarted );
}

double GE3D::Application::iApplication::GetElapsedSecondCount_simulation() const
{
	return Time::ConvertTicksToSeconds( m_tickCount_simulationTime_totalElapsed );
}

void GE3D::Application::iApplication::SetSimulationRate( const float i_simulationRate )
{
...
int GE3D::Application::iApplication::ParseEntryPointParametersAndRun( const sEntryPointParameters& i_entryPointParameters )
{
...
GE3D::cResult GE3D::Application::iApplication::Exit( const int i_exitCode )
{
...
void GE3D::Application::iApplication::RegisterOnImGuiRenderUI(const std::function<void()>& i_OnImGuiRenderUI)
{
...
void GE3D::Application::iApplication::UpdateUntilExit()
{
...
void GE3D::Application::iApplication::EntryPoint_applicationLoopThread( void* const io_application )
{
...
GE3D::cResult GE3D::Application::iApplication::Initialize_all( const sEntryPointParameters& i_entryPointParameters )
{
	...
	{
		GE3D_ASSERTF( false, "Application can't be initialized without Logging" );
		return result;
	}
	...
	{
		GE3D_ASSERTF( false, "Application can't be initialized without Time" );
		return result;
	}
	...
	{
		GE3D_ASSERTF( false, "Application couldn't be initialized" );
		return result;
	}
	...
	{
		GE3D_ASSERTF( false, "Application can't be initialized without the loop thread" );
...
GE3D::cResult GE3D::Application::iApplication::Initialize_engine()
{
	auto result = Results::Success;
	...
	// User Output
	{
		...
		if ( result = PopulateUserOutputInitializationParameters( initializationParameters ) )
		{
			...
			{
				GE3D_ASSERTF( false, "Application can't be initialized without UserOutput" );
				return result;
			}
		}
		else
	...
	// Graphics
	{
		...
		if ( result = PopulateGraphicsInitializationParameters( initializationParameters ) )
		{
			...
			{
				GE3D_ASSERTF( false, "Application can't be initialized without Graphics" );
				return result;
			}
		}
		else
		{
			GE3D_ASSERTF( false, "Application can't be initialized without Graphics initialization parameters" );
			return result;
		}
	}
...
GE3D::cResult GE3D::Application::iApplication::CleanUp_all()
{
	auto result = Results::Success;
	...
	// Exit the application loop
	{
		...
		// Wait for the thread to exit
		{
			...
			{
				GE3D_ASSERTF( false, "Couldn't wait for the application loop thread to exit" );
	...
	// Clean up the derived application
	{
		...
		{
			GE3D_ASSERTF( false, "Application couldn't be cleaned up" );
			if ( result )
			{
...
GE3D::cResult GE3D::Application::iApplication::CleanUp_engine()
{
	auto result = Results::Success;
	...
	// Graphics
	{
		...
		if ( !result_graphics )
		{
			GE3D_ASSERTF( false, "Graphics wasn't successfully cleaned up" );
			if ( result )
			{
