...
#ifndef GE3D_AUDIOSYSTEM_H
#define GE3D_AUDIOSYSTEM_H
...
namespace GE3D
{
	namespace AudioSystem
	{
		...
		public:
			...
			GE3D::cResult CloseAudio();

		private:
			bool IsPlaying_WithName(std::string i_audioName);

			GE3D::cResult CloseAudio_WithName(std::string i_audioName);
