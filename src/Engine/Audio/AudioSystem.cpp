...
namespace
{
	...
	{
		std::vector<GE3D::AudioSystem::cAudio*> m_AudioList;
...
void GE3D::AudioSystem::cAudio::CreateAudioData(std::string i_filePath, std::string i_audioName, size_t i_volume, bool i_isLoop)
{
...
void GE3D::AudioSystem::cAudio::SubmitAudioSource()
{
	MCIERROR mciError;
...
void GE3D::AudioSystem::cAudio::Play()
{
...
void GE3D::AudioSystem::cAudio::PlayIndependent()
{
...
void GE3D::AudioSystem::cAudio::PauseAudio()
{
	MCIERROR mciError;
	WCHAR errorMessage[128];
...
void GE3D::AudioSystem::cAudio::ResumeAudio()
{
	MCIERROR mciError;
	WCHAR errorMessage[128];
...
void GE3D::AudioSystem::cAudio::SetVolume(size_t i_volume)
{
...
bool GE3D::AudioSystem::cAudio::IsPlaying()
{
	return IsPlaying_WithName(audioName);
}

bool GE3D::AudioSystem::cAudio::IsPlaying_WithName(std::string i_audioName)
{
	bool retValue = false;
...
GE3D::cResult GE3D::AudioSystem::cAudio::CloseAudio()
{
	GE3D::cResult retValue = Results::Success;
...
GE3D::cResult GE3D::AudioSystem::cAudio::CloseAudio_WithName(std::string i_audioName)
{
	GE3D::cResult retValue = Results::Success;
...
GE3D::cResult GE3D::AudioSystem::Initialize()
{
...
GE3D::cResult GE3D::AudioSystem::CleanUp()
{
	auto result = Results::Success;
