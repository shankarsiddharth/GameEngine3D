#ifndef GE3D_MATH_CQUATERNION_INL
#define GE3D_MATH_SVGE3D_MATH_CQUATERNION_INLECTOR_INL
...
constexpr GE3D::Math::cQuaternion GE3D::Math::cQuaternion::operator *( const cQuaternion& i_rhs ) const
{
	return cQuaternion(
...
constexpr GE3D::Math::sVector GE3D::Math::cQuaternion::operator *( const sVector& i_rhs ) const
{
...
constexpr float GE3D::Math::Dot( const cQuaternion& i_lhs, const cQuaternion& i_rhs )
{
...
constexpr void GE3D::Math::cQuaternion::Invert()
{
	m_x = -m_x;
	m_y = -m_y;
	m_z = -m_z;
...
constexpr GE3D::Math::cQuaternion GE3D::Math::cQuaternion::GetInverse() const
{
...
constexpr GE3D::Math::sVector GE3D::Math::cQuaternion::CalculateForwardDirection() const
{
...
constexpr GE3D::Math::cQuaternion::cQuaternion( const float i_w, const float i_x, const float i_y, const float i_z )
	:
...
#endif// GE3D_MATH_CQUATERNION_INL
