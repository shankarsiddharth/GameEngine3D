#ifndef GE3D_MATH_CMATRIX_TRANSFORMATION_INL
#define GE3D_MATH_CMATRIX_TRANSFORMATION_INL
...
constexpr GE3D::Math::sVector GE3D::Math::cMatrix_transformation::operator *( const sVector& i_rhs ) const
{
	return sVector(
...
constexpr GE3D::Math::cMatrix_transformation GE3D::Math::cMatrix_transformation::operator *( const cMatrix_transformation& i_rhs ) const
{
...
constexpr GE3D::Math::cMatrix_transformation GE3D::Math::cMatrix_transformation::ConcatenateAffine(
...
constexpr GE3D::Math::cMatrix_transformation GE3D::Math::cMatrix_transformation::CreateWorldToCameraTransform(
...
constexpr GE3D::Math::cMatrix_transformation GE3D::Math::cMatrix_transformation::CreateWorldToCameraTransform( const cMatrix_transformation& i_transform_localCameraToWorld )
{
...
constexpr GE3D::Math::cMatrix_transformation::cMatrix_transformation(
...
#endif	// GE3D_MATH_CMATRIX_TRANSFORMATION_INL
