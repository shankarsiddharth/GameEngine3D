...
const GE3D::Math::sVector& GE3D::Math::cMatrix_transformation::GetRightDirection() const
{
	return *reinterpret_cast<const sVector*>( &m_00 );
}

const GE3D::Math::sVector& GE3D::Math::cMatrix_transformation::GetUpDirection() const
{
	return *reinterpret_cast<const sVector*>( &m_01 );
}

const GE3D::Math::sVector& GE3D::Math::cMatrix_transformation::GetBackDirection() const
{
	return *reinterpret_cast<const sVector*>( &m_02 );
}

const GE3D::Math::sVector& GE3D::Math::cMatrix_transformation::GetTranslation() const
{
...
GE3D::Math::cMatrix_transformation GE3D::Math::cMatrix_transformation::CreateCameraToProjectedTransform_perspective(
...
GE3D::Math::cMatrix_transformation::cMatrix_transformation( const cQuaternion& i_rotation, const sVector& i_translation )
	:
