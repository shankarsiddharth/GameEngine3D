...
namespace GE3D
{
	namespace Camera
	{
		...
		public:
			...
			GE3D::Math::cMatrix_transformation GetWorldToCameraTransform() const;
			GE3D::Math::cMatrix_transformation GetCameraToProjectedTransform_Perspective() const;
		...
		private:
			...
			GE3D::Math::cMatrix_transformation m_worldToCameraTransform;
			GE3D::Math::cMatrix_transformation m_cameraToProjectedTransform_perspective;
