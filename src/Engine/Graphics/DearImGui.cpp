...
GE3D::cResult GE3D::Graphics::DearImGui::InitializeImGui(const sInitializationParameters& i_initializationParameters)
{
	...
	{
		GE3D_ASSERTF(false, "Can't create ImGui context");
		return result;
	}
	...
	{
		GE3D_ASSERTF(false, "Can't initialize ImGui IO");
		return result;
	}
	...
	{
		GE3D_ASSERTF(false, "Can't initialize platform-specific / Renderer backend specific ImGui context");
		return result;
	}
	...
	{
		GE3D_ASSERTF(false, "Can't load ImGui Fonts");
		return result;
	}
...
void GE3D::Graphics::DearImGui::RenderImGuiFrame()
{
	// Rendering
	ImGui::Render();
}

GE3D::cResult GE3D::Graphics::DearImGui::CreateImGuiContext()
{
	auto result = Results::Success;
...
GE3D::cResult GE3D::Graphics::DearImGui::InitializeImGuiIO()
{
	auto result = Results::Success;
...
void GE3D::Graphics::DearImGui::InitializeImGuiStyle()
{
...
GE3D::cResult GE3D::Graphics::DearImGui::LoadImGuiFonts()
{
	auto result = Results::Success;
...
void GE3D::Graphics::DearImGui::RenderImGuiUI()
{
