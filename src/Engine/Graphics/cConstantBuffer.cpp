...
GE3D::cResult GE3D::Graphics::cConstantBuffer::Initialize( const void* const i_initialData )
{
...
//				case ConstantBufferTypes::Material: m_size = sizeof( ConstantBufferFormats::sMaterial ); break;
	...
	{
		result = Results::Failure;
		GE3D_ASSERTF( false, "Invalid constant buffer type %u", m_type );
...
GE3D::Graphics::cConstantBuffer::cConstantBuffer( const ConstantBufferTypes i_type )
	:
	m_type( i_type )
{
...
GE3D::Graphics::cConstantBuffer::~cConstantBuffer()
{
