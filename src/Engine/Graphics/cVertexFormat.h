...
#ifndef GE3D_GRAPHICS_VERTEXFORMATS_H
#define GE3D_GRAPHICS_VERTEXFORMATS_H
...
namespace GE3D
{
	namespace Graphics
	{
		...
		public:
			...
			GE3D_ASSETS_DECLAREDELETEDREFERENCECOUNTEDFUNCTIONS( cVertexFormat );
...
#endif	// GE3D_GRAPHICS_VERTEXFORMATS_H
