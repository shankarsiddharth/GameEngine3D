...
GE3D::cResult GE3D::Assets::iBuilder::ParseCommandArgumentsAndBuild( char* const* i_arguments, const unsigned int i_argumentCount )
{
	...
	{
		GE3D_ASSERT( i_arguments != nullptr );
	...
	{
		{
			...
			GE3D::Assets::OutputErrorMessage( errorMessage.str().c_str() );
		}
