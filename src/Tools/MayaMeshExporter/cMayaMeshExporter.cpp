...
namespace
{
	...
	// Note that this is independent of the GE3D::Graphics::VertexFormats::sMesh struct
...
MStatus GE3D::cMayaMeshExporter::writer( const MFileObject& i_file, const MString& i_options, FileAccessMode i_mode )
{
	MStatus status;
