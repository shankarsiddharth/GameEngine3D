...
#ifndef GE3D_CMAYAMESHEXPORTER_H
#define GE3D_CMAYAMESHEXPORTER_H
...
namespace GE3D
{
	...
	public:
		...
		MString defaultExtension() const final { return "json"; }	// A string literal like "mesh" will convert automatically to an MString
...
#endif	// GE3D_CMAYAMESHEXPORTER_H
