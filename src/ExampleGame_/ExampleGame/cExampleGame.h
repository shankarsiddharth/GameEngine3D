...
#ifndef GE3D_CEXAMPLEGAME_H
#define GE3D_CEXAMPLEGAME_H
...
namespace GE3D
{
	...
	private:
		...
		const char* GetMainWindowClassName() const final { return "GE3D Example Main Window Class"; }
